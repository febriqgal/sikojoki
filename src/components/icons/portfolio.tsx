...
export default function PortfolioIcon({
  ...
  return (
    ...
    >
      <path
        opacity="0.4"
        d="M21 17V10C21 7.79086 19.2987 6 17.2 6H14.6667C13.8445 6 13.0444 5.71929 12.3867 5.2L10.6133 3.8C9.95557 3.28071 9.15554 3 8.33333 3H5.8C3.70132 3 2 4.79086 2 7V17C2 19.2091 3.70132 21 5.8 21H17.2C19.2987 21 21 19.2091 21 17Z"
      />
      <path
        fillRule="evenodd"
        clip-rule="evenodd"
